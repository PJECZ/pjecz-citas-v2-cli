...
def get_enc_servicios(
    ...
    try:
        ...
        raise CLIConnectionError("No hubo respuesta al solicitar encuestas de servicios") from error
    except requests.exceptions.HTTPError as error:
        raise CLIStatusCodeError("Error Status Code al solicitar encuestas de servicios: " + str(error)) from error
    except requests.exceptions.RequestException as error:
        raise CLIRequestError("Error inesperado al solicitar encuestas de servicios") from error
