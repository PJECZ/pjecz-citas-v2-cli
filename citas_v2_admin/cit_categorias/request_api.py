...
def get_cit_categorias(
    ...
    try:
        ...
        raise CLIConnectionError("No hubo respuesta al solicitar categorias") from error
    except requests.exceptions.HTTPError as error:
        raise CLIStatusCodeError("Error Status Code al solicitar categorias: " + str(error)) from error
    except requests.exceptions.RequestException as error:
        raise CLIRequestError("Error inesperado al solicitar categorias") from error
